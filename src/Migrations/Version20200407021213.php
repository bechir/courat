...
final class Version20200407021213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE info ADD COLUMN title_ar VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_D8698A768F5EA509 ON document (classe_id)');
        $this->addSql('CREATE INDEX IDX_D8698A7612469DE2 ON document (category_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__info AS SELECT id, title, link, filename, updated_at, created_at, slug FROM info');
        ...
        $this->addSql('INSERT INTO info (id, title, link, filename, updated_at, created_at, slug) SELECT id, title, link, filename, updated_at, created_at, slug FROM __temp__info');
