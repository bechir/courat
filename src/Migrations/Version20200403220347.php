 ...
 */
final class Version20200403220347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__resource AS SELECT id, title, subtitle, link, updated_at, filename, subtitle_ar FROM resource');
        $this->addSql('DROP TABLE resource');
        $this->addSql('CREATE TABLE resource (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, subtitle VARCHAR(255) DEFAULT NULL COLLATE BINARY, link VARCHAR(255) NOT NULL COLLATE BINARY, updated_at DATETIME DEFAULT NULL, filename VARCHAR(255) DEFAULT NULL COLLATE BINARY, subtitle_ar VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO resource (id, title, subtitle, link, updated_at, filename, subtitle_ar) SELECT id, title, subtitle, link, updated_at, filename, subtitle_ar FROM __temp__resource');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_26A363913D865311 ON planning_subject (planning_id)');
        $this->addSql('CREATE INDEX IDX_26A3639123EDC87 ON planning_subject (subject_id)');
        $this->addSql('ALTER TABLE resource ADD COLUMN title_ar VARCHAR(255) DEFAULT NULL COLLATE BINARY');
    }
}
