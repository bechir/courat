 ...
 */
final class Version20200402044021 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__resource AS SELECT id, title, subtitle, link, image, updated_at FROM resource');
        $this->addSql('DROP TABLE resource');
        $this->addSql('CREATE TABLE resource (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, subtitle VARCHAR(255) DEFAULT NULL COLLATE BINARY, link VARCHAR(255) NOT NULL COLLATE BINARY, updated_at DATETIME DEFAULT NULL, filename VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO resource (id, title, subtitle, link, filename, updated_at) SELECT id, title, subtitle, link, image, updated_at FROM __temp__resource');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE resource');
        $this->addSql('CREATE TABLE resource (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, subtitle VARCHAR(255) DEFAULT NULL, link VARCHAR(255) NOT NULL, updated_at DATETIME DEFAULT NULL, image VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO resource (id, title, subtitle, link, image, updated_at) SELECT id, title, subtitle, link, filename, updated_at FROM __temp__resource');
        $this->addSql('DROP TABLE __temp__resource');
    }
}
