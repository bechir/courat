 ...
 */
final class Version20200408163345 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__app_user AS SELECT id, username, roles, password FROM app_user');
        ...
        $this->addSql('INSERT INTO app_user (id, username, roles, password) SELECT id, username, roles, password FROM __temp__app_user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE app_user ADD COLUMN status BOOLEAN DEFAULT \'0\'');
        $this->addSql('DROP INDEX IDX_80575E1B8F5EA509');
        $this->addSql('DROP INDEX IDX_80575E1B23EDC87');
        $this->addSql('CREATE TEMPORARY TABLE __temp__classe_subject AS SELECT classe_id, subject_id FROM classe_subject');
        $this->addSql('DROP TABLE classe_subject');
