 ...
 */
final class Version20200330222545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__planning AS SELECT id FROM planning');
        ...
        $this->addSql('INSERT INTO planning (id) SELECT id FROM __temp__planning');
