 ...
 */
final class Version20200330173216 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE planning_day (planning_id INTEGER NOT NULL, day_id INTEGER NOT NULL, PRIMARY KEY(planning_id, day_id))');
        $this->addSql('CREATE INDEX IDX_E4F9E7A23D865311 ON planning_day (planning_id)');
        $this->addSql('CREATE INDEX IDX_E4F9E7A29C24126 ON planning_day (day_id)');
