 ...
 */
final class Version20200405223252 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__document AS SELECT id, subject_id, classe_id, category_id, title, path, size, client_ip, updated_at, file_url FROM document');
        ...
        $this->addSql('INSERT INTO document (id, subject_id, classe_id, category_id, title, path, size, client_ip, updated_at, file_url) SELECT id, subject_id, classe_id, category_id, title, path, size, client_ip, updated_at, file_url FROM __temp__document');
