...
class ArticleFixtures extends Fixture
{
    ...
    public function getData(): array
    {
        return [
            ...
            ['02/04/2020 07:45', 'سنة بيضاء ستكون كارثة مالية للدولة وخسارة للجيل الشاب (وزير)', 'Une année blanche sera une catastrophe financière pour l’Etat et une perte pour la jeune génération (Ministre)', 'http://cridem.org/C_Info.php?article=734479', 'sidi_uld_salem_635_0.jpg'],
